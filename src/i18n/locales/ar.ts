...
export const ar: I18nDictionary = {
  ...
  dashboard: {
    ...
    welcomeSectionAriaLabel: "ترحيب لوحة التحكم والنطاق الزمني",
    dateRange: {
      label: "النطاق الزمني للوحة التحكم",
    ...
    platformActivityTabsAriaLabel: "مقياس نشاط المنصة",
    platformActivityChartAriaLabel: "مخطط نشاط المنصة",
    boothOverview: "نظرة عامة على الأجنحة",
    boothOverviewChartAriaLabel: "نظرة عامة على توفر الأجنحة",
    totalBooths: "إجمالي الأجنحة",
    ...
    quickOverview: {
      ...
      pendingBoothRequests: "طلبات الأجنحة المعلقة",
  ...
  visitor: {
    ...
    filters: {
      ...
      businessSectors: {
        ...
        media: "الإعلام",
        non_profit: "المنظمات غير الربحية",
        commerce: "التجارة",
        ...
        tourism: "السياحة",
        transportation_logistics: "النقل والخدمات اللوجستية",
  ...
  volunteers: {
    title: "طلبات التطوع",
    description: "راجع وأدر طلبات التطوع.",
    loadingDetails: "جارٍ تحميل تفاصيل طلب التطوع...",
    loadDetailsError: "تعذر تحميل تفاصيل طلب التطوع.",
    summary: {
      ariaLabel: "إحصاءات طلبات التطوع",
      total: "إجمالي الطلبات",
      pending: "قيد الانتظار",
      approved: "مقبولة",
      rejected: "مرفوضة",
      loadError: "تعذر تحميل إحصاءات طلبات التطوع.",
      loading: "جارٍ تحميل إحصاءات طلبات التطوع...",
      unavailable: "إحصاءات طلبات التطوع غير متاحة",
    },
    filters: {
      searchPlaceholder: "ابحث بالاسم أو البريد الإلكتروني أو الهاتف...",
      searchAriaLabel: "البحث في طلبات التطوع",
      filterLabel: "تصفية",
      filterAriaLabel: "تصفية طلبات التطوع",
      status: "الحالة",
      allStatuses: "كل الحالات",
      panelAriaLabel: "عوامل تصفية طلبات التطوع",
      sort: "الترتيب",
      newestFirst: "الأحدث أولاً",
      oldestFirst: "الأقدم أولاً",
      nameAscending: "اسم مقدم الطلب: أ–ي",
      nameDescending: "اسم مقدم الطلب: ي–أ",
      statusAscending: "الحالة: أ–ي",
      statusDescending: "الحالة: ي–أ",
    },
    table: {
      ariaLabel: "طلبات التطوع",
      name: "مقدم الطلب",
      email: "البريد الإلكتروني",
      phone: "الهاتف",
      status: "الحالة",
      createdAt: "تاريخ الإرسال",
      openDetails: "فتح تفاصيل طلب التطوع",
      empty: "لا توجد طلبات تطوع.",
      loading: "جارٍ تحميل طلبات التطوع...",
      loadError: "تعذر تحميل طلبات التطوع.",
    },
    status: {
      pending: "قيد الانتظار",
      approved: "مقبولة",
    ...
    details: {
      ...
      phone: "الهاتف",
      city: "المدينة",
      educationOrOccupation: "التعليم أو المهنة",
      skills: "المهارات",
      submittedAt: "تاريخ الإرسال",
      motivation: "الدافع للتطوع",
      review: "ملاحظة المراجعة",
      reviewNote: "ملاحظة المراجعة (اختيارية)",
      viewCv: "عرض السيرة الذاتية",
      noCv: "لا توجد سيرة ذاتية مرفقة بهذا الطلب.",
      cvError: "تعذر فتح السيرة الذاتية.",
      reviewError: "تعذر تحديث طلب التطوع.",
      approve: "قبول",
      reject: "رفض",
    },
  },
