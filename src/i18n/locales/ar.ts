...
export const ar: I18nDictionary = {
  ...
  notifications: {
    title: "النشاط الأخير",
    description: "راجع أحدث إشعارات وتقارير المنصة.",
    panelAriaLabel: "نشاط الإشعارات والتقارير",
    tabs: {
      ariaLabel: "فئات النشاط الأخير",
    ...
    search: {
      notificationsPlaceholder: "البحث في الإشعارات حسب العنوان...",
      notificationsAriaLabel: "البحث في الإشعارات حسب العنوان",
      reportsPlaceholder: "البحث في التقارير حسب العنوان...",
      reportsAriaLabel: "البحث في التقارير حسب العنوان",
    },
    filters: {
      notificationsFilterAriaLabel: "فتح عوامل تصفية الإشعارات",
      reportsFilterAriaLabel: "فتح عوامل تصفية التقارير",
      notificationsPanelAriaLabel: "عوامل تصفية الإشعارات",
      reportsPanelAriaLabel: "عوامل تصفية التقارير",
      status: "الحالة",
      type: "النوع",
      all: "الكل",
      reset: "إعادة ضبط",
    ...
    table: {
      notificationsAriaLabel: "الإشعارات الأخيرة",
      reportsAriaLabel: "التقارير الأخيرة",
      notification: "الإشعار",
      report: "التقرير",
      type: "النوع",
      status: "الحالة",
      date: "التاريخ",
      emptyNotifications: "لا توجد إشعارات متاحة.",
      emptyReports: "لا توجد تقارير متاحة.",
      noResults: "لا يوجد نشاط يطابق البحث أو عوامل التصفية.",
