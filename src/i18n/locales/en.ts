export const en = {
  ...
  notifications: {
    ...
    description: "Review your latest platform notifications and reports.",
    panelAriaLabel: "Notifications and reports activity",
    tabs: {
    ...
    search: {
      notificationsPlaceholder: "Search notifications by title...",
      notificationsAriaLabel: "Search notifications by title",
      reportsPlaceholder: "Search reports by title...",
      reportsAriaLabel: "Search reports by title",
    },
    filters: {
      notificationsFilterAriaLabel: "Open notification filters",
      reportsFilterAriaLabel: "Open report filters",
      notificationsPanelAriaLabel: "Notification filters",
      reportsPanelAriaLabel: "Report filters",
      status: "Status",
      type: "Type",
      all: "All",
      reset: "Reset",
    ...
    table: {
      notificationsAriaLabel: "Recent notifications",
      reportsAriaLabel: "Recent reports",
      notification: "Notification",
      report: "Report",
      type: "Type",
      status: "Status",
      date: "Date",
      emptyNotifications: "No notifications are available.",
      emptyReports: "No reports are available.",
      noResults: "No activity matches your search or filters.",
